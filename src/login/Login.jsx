  ...
  async function handleLogin(event) {
    ...
    if (loginAccount.username === "" || loginAccount.password === "") {
      ...
      try {
        ...
        // console.log(body);
        await axios
          .post("https://starfish-app-uva3q.ondigitalocean.app/crushie/users/login", body, config)
          .then((res) => {
            setLoggedIn(true);
  ...
  return (
    <div class="login">
      <form class="create-form">
        ...
        <div class="below-box">
          {credentialsError ? (
            <p class="below-box passwordError">
              Please Enter Credentials in all the Fields!
            </p>
          ) : null}
          <button
            type="submit"
